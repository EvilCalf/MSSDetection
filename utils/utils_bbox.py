...
class BBoxUtility(object):
    ...
    def MSSDet_correct_boxes(self, box_xy, box_wh, input_shape, image_shape, letterbox_image):
        #-----------------------------------------------------------------#
    ...
    def decode_box(self, predictions, anchors, image_shape, input_shape, letterbox_image, variances = [0.1, 0.1, 0.2, 0.2], confidence=0.5):
        ...
        for i in range(len(mbox_loc)):
            ...
            if len(results[-1]) > 0:
                ...
                results[-1][:, :4] = self.MSSDet_correct_boxes(box_xy, box_wh, input_shape, image_shape, letterbox_image)
